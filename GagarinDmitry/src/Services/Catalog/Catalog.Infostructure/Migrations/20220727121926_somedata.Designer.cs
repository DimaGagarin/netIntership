...
namespace Catalog.Infostructure.Migrations
{
    ...
    [Migration("20220727121926_somedata")]
            ...
            modelBuilder.Entity("Catalog.Domain.Entities.Session", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CinemaId = 1,
                            StartTime = new DateTimeOffset(new DateTime(2022, 7, 27, 15, 19, 26, 465, DateTimeKind.Unspecified).AddTicks(3119), new TimeSpan(0, 3, 0, 0, 0)),
                            TicketPrice = 12m,
                            Title = "asd"
                        });
                });
